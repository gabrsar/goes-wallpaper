...
# Define paths
CURRENT_DIR=$(pwd)
SCRIPT_FILE="$CURRENT_DIR/goes-mac.sh"
...
echo ""
echo "To stop the service, run: launchctl bootout gui/$UID \"$PLIST_FILE\""
echo "To start the service again, run: launchctl bootstrap gui/$UID \"$PLIST_FILE\""
